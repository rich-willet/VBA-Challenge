    ...
    For Each ws In Worksheets
        ...
        GreatDecr = ws.Cells(2, 11).Value
            ...
            For i = 2 To LastRowI
                ...
                'For greatest total volume, check if next value is larger
                ...
                'For greatest increase, check if next value is larger
                ...
                'For greatest decrease, check if next value is smaller
